...
module.exports = {
  ...
  description: 'Get current list of all failing templates. This can be used to update the `pending` listing in `.tempalte-lintrc.js`.',
  works: 'insideProject',
  ...
  run: function(options) {
    ...
    console.log('Add the following to your `.tempate-lintrc.js` file to mark these files as pending.\n\n');
